...
- [ ] Rust crate (`wickra-copilot-core`)
- [ ] Python (`pip install wickra-copilot`)
- [ ] Node.js (`npm install wickra-copilot`)
- [ ] WASM
- [ ] C ABI (`bindings/c`)
- [ ] C# (`WickraCopilot` on NuGet)
- [ ] Go (`bindings/go`)
- [ ] Java (`org.wickra:wickra-copilot` on Maven Central)
- [ ] R (`bindings/r`)
- [ ] CLI (`wickra-copilot`)
- [ ] Docs / examples only
...
| Field                | Value                                  |
| -------------------- | -------------------------------------- |
| Wickra Copilot version       | `e.g. 0.4.2`                           |
