...
A follow-up release: the assistant and its bindings are unchanged. It pins
...
A maintenance release: the assistant and its bindings are unchanged. It
...
- **Third-party dependencies refreshed.** `Cargo.lock` takes 40 crates to their
...
[Unreleased]: https://github.com/wickra-lib/wickra-copilot/compare/v0.1.3...HEAD
[0.1.3]: https://github.com/wickra-lib/wickra-copilot/compare/v0.1.2...v0.1.3
[0.1.2]: https://github.com/wickra-lib/wickra-copilot/compare/v0.1.1...v0.1.2
